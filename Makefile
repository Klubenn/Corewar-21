...
$(NAME_ASM): $(INCL_ASM) $(SRC_ASM) $(OBJ_ASM)
	gcc $(FLAGS) $(OBJ_ASM) -I$(INCL_DIR_ASM) -I$(LIBFT_DIR) -I$(PRINTF_DIR) -L$(LIBFT_DIR) -$(LIBFT) -L$(PRINTF_DIR) -$(PRINTF) -o $(NAME_ASM)

$(OBJ_DIR_ASM)%.o: $(SRC_DIR_ASM)%.c $(INCL_ASM)
	gcc $(FLAGS) -I $(INCL_DIR_ASM) -o $@ -c $<

$(NAME_VM): $(INCL_VM) $(SRCS_VM) $(OBJ_VM)
	gcc $(FLAGS) $(OBJ_VM) -I$(INCL_DIR_VM) -I$(LIBFT_DIR) -I$(PRINTF_DIR) -L$(LIBFT_DIR) -$(LIBFT) -L$(PRINTF_DIR) -$(PRINTF) -o $(NAME_VM)
